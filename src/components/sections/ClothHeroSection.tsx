...
interface ClothHeroSectionProps {
  embedded?: boolean;
}
...
export default function ClothHeroSection({ embedded = false }: ClothHeroSectionProps) {
  ...
  useEffect(() => {
    ...
    // Cloth geometry - Made slightly bigger for hero section (was 2.0, 4.0)
    ...
    // Adjusted camera position to be slightly closer for hero effect
